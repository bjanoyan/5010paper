...
\begin{figure}[H]
	\begin{subfigure}[b]{0.75\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{price_monthly.png}
		\caption{}
		\label{fig:}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.75\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{price_annual.png}
		\caption{}
		\label{fig:}
	\end{subfigure}
...
\begin{figure}[H]
	\begin{subfigure}[b]{0.75\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{gen_annual.png}
		\caption{}
		\label{fig:}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.75\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{gen_monthly.png}
		\caption{}
		\label{fig:}
	\end{subfigure}
...
\begin{mini}
	{}
	{\frac{1}{2}\|w\|^{2}+C \sum_{i=1}^{\ell}\left(\xi_{i}+\xi_{i}^{*}\right)}{}\\
	\addConstraint{y_{i}-\left\langle w, x_{i}\right\rangle-b}{\le \epsilon + \xi_i}
	\addConstraint{\langle w, x_i \rangle + b - y_i}{\le \epsilon + \xi_i^{*}}
	\addConstraint{\xi_i, \xi_i^{*}}{\ge 0}
\end{mini}
\begin{figure}[H]
	\centering
